...
<div className="flex items-center">
    ...
    Continue Browsing
      ...
      ref={form}
      onSubmit={sendEmail}
      className="w-[90%] md:w-[30%] p-7 lg:p-5 h-max lg:h-screen  flex flex-col  justify-center gap-8 mt-12 bg-neutral-100 border border-neutral-200 shadow-sm rounded-2xl"
      >
        ...
        <label className="flex flex-col gap-2 text-sm">
          <span className="text-neutral-800">Your message</span>
          <textarea
            name="message"
            className="w-full h-40 p-3 text-sm rounded-md border border-neutral-300 bg-neutral-200 text-black outline-none "
...
{
  loading ? 
  <Button  disabled className="rounded-full py-6  bg-neutral-600">
    <Spinner />
    Submitting
      </Button> : 
  <Button   className="rounded-full py-6 cursor-pointer bg-black hover:bg-neutral-800">
        Submit
      </Button>
      }
