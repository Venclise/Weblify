...
import { Circle, Code, Layers, Layout, Text } from 'lucide-react';
...
function CarouselItem({ item, index, itemWidth, round, trackItemOffset, x, transition }: CarouselItemProps) {
  ...
  return (
    <motion.div
      ...
      className={` shrink-0 flex flex-col items-center justify-center h-screen w-full  ${
        round
    ...
    >
      ...
      <Image src={item.img} alt={item.title} fill className='w-full h-full object-cover'/>
        </div>
      <div className="p-5">
